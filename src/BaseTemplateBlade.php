...
class BaseTemplateBlade
{
     ...
     * @var array
     */
    protected $_compilers = ['extensions', 'comments', 'echos', 'forelse', 'empty', 'endforelse', 'structure_openings',
                             'structure_closings', 'else', 'unless', 'endunless', 'includes', 'layouts', 'extends', 'section_start',
                             'section_end', 'stop', 'yields', 'yield_sections'];
    /**
