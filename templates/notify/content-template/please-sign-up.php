...
<div class="notification-block">
    <div class="notice-wrapper">
        ...
        <p class="link-login">Hãy <span><a href="<?= isset($config_sign_up_link) ? $config_sign_up_link : NULL; ?>" title="đăng ký">đăng ký</a> để có thể xem toàn bộ nội dung bài viết nhé !</span>
        </p>
    </div>
</div>
