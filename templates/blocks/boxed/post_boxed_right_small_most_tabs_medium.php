...
<!-- post_boxed_right_small_most_tabs_medium -->
<div class="tabs no_scroll <?php if ($margin_top_section == 'yes') { echo "page_margin_top_section"; } ?> clearfix">
    ...
    <?php foreach ($tabs_content as $item) {
        echo modules::run('site-blocks/site_boxed/post_boxed_right_small_most_tabs_medium_item', $item['table_id'], $item['table_data']);
    } ?>
</div>